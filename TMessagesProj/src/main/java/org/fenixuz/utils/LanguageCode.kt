...
object LanguageCode {
    ...
    private fun  initTitles() {
        ...
        titlesLanguages.add(TitleLanguages(394, "Admin groups", "Admin guruh", "Админ группы"))
        titlesLanguages.add(TitleLanguages(395, "My channels", "Kanallarim", "Мои каналы"))
        titlesLanguages.add(TitleLanguages(396, "Adm channels", "Admin kanal", "Админ каналы"))
