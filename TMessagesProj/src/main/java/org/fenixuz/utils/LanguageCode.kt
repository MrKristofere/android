...
object LanguageCode {
    ...
    private fun  initTitles() {
        ...
        titlesLanguages.add(TitleLanguages(393, "My groups", "Mening guruhlarim", "Мои группы"))
        titlesLanguages.add(TitleLanguages(394, "Admin groups", "Admin guruhlar", "Группы-админ"))
        titlesLanguages.add(TitleLanguages(395, "My channels", "Mening kanallarim", "Мои каналы"))
        titlesLanguages.add(TitleLanguages(396, "Admin channels", "Admin kanallar", "Каналы-админ"))
